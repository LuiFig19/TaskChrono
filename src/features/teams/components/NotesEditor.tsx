...
/**
 * NotesEditor
 * Lightweight Tiptap-based rich text editor with a minimal toolbar for team notes.
 */
...
export default forwardRef<
  NotesEditorHandle,
  { initialMarkdown: string; onEmojiClick?: () => void }
>(function NotesEditor({ initialMarkdown }, ref) {
  const editor = useEditor({
    extensions: [StarterKitExt.configure({})],
  ...
  useEffect(() => {
    if (editor && typeof initialMarkdown === 'string') {
      ...
      editor.commands.setContent(initialMarkdown || '', { emitUpdate: false } as any);
    }
