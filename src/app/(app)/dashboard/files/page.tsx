    ...
    <div className="max-w-screen-2xl mx-auto px-4 pt-4 pb-6">
      ...
      <form action={createFileRecord} className="mt-4 flex gap-2">
        ...
        <input
          ...
          className="w-80 px-3 py-2 rounded-md border border-slate-700 bg-slate-900 text-slate-100"
        />
      ...
      <div className="mt-4">
        ...
        >
          ...
          />
          <button
            className="px-3 py-2 rounded-md border border-slate-700 hover:bg-slate-800 text-slate-200"
        ...
        <div className="text-xs text-slate-500 mt-1">
          Note: Uploads are saved locally to /public/uploads when available.
        </div>
      </div>
      <div className="mt-6">
        {files.length === 0 ? (
