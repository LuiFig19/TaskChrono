        ...
        <div className="fixed inset-0 z-[100000]">
          ...
          <div className="absolute inset-0 grid place-items-center p-4">
            <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-950 to-slate-900 p-5 shadow-2xl">
              ...
              <form
                onSubmit={(e)=>{e.preventDefault(); if (inputRef.current) inputRef.current.value = name || 'Timer'; setBusy(true); if (formRef.current) formRef.current.requestSubmit(); setBusy(false); setOpen(false); document.dispatchEvent(new CustomEvent('tc:timer:changed'))}}
