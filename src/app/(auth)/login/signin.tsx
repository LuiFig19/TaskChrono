...
export function SignIn({ callbackUrl }: { callbackUrl: string }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full px-5 py-3 rounded-md bg-white text-slate-900 font-medium hover:bg-slate-100 transition-colors disabled:opacity-60 shadow-lg flex items-center justify-center gap-2"
    >
